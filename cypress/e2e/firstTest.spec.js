...
describe('First test suit',() => {
    ...
    it('first test',() => {
        ...
        //we have allready provide the internet site in cypress.config.js
        cy.visit('/')
        ...
        //by two attributes (put all attributes without spaces)
    ...
    it('Date picker', () =>{
        ...
        cy.contains('nb-card', 'Common Datepicker').find('input').then( input => {
            cy.wrap(input).click()
            const dateToAssert = selectDayFromCurrent(19)
    ...
    it('Lists and dropdowns', () =>{
        ...
        cy.get('nav nb-select').then(dropDown =>{
            ...
            cy.get('.options-list nb-option').each( (listItem, index) =>{
                //trim is a javascript method, that remove all the spaces
    ...
    it('web tables', ()=>{
        ...
        cy.wrap(age).each(age =>{
            ...
            //cypress is faster than the refreshing the page after typing 20
            cy.wait(500)
    ...
    it('tooltip', ()=>{
        ...
        //we found locator for tooltip in Cypress-runner
